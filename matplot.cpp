...
void MatPlot::display_figure() {
    cout << "void MatPlot::display_figure()" << endl;
...
void MatPlot::display_layer2(){
    cout << "void MatPlot::display_layer2(){" << endl;
//    int l,t,w,h,r;
//    string s;
//    l=1;
//    t=1;
...
{
    cout << "void MatPlot::Layer_mouse(int button, int state, int x, int y )" << endl;
//    int l,t,w,h;
//    int is;
//    double dt;
//    l=1;
...
void MatPlot::display_axes_2d(){
    cout << "void MatPlot::display_axes_2d(){" << endl;
...
{
    cout << "void MatPlot::display_axes_3d() " << endl;
//    char ctmp[100];
//    float l,b,w,h;//left,bottom,width,height
//    float r=0.01;
...
{
    cout << "void MatPlot::display_axes_colorbar()" << endl;
//    char ctmp[100];
//    float l,b,w,h;//left,bottom,width,height
//    float r=0.01;
...
{
    cout << "void MatPlot::Axes_mouse(int button, int state, int x, int y )" << endl;
//    float X,Y;
...
{
    cout << "void MatPlot::display_line()" << endl;
//    if(is_debug1){printf("mode: %d handle: %4d Line \n",
//                         mode,cl->id);}
...
{
    cout << "void MatPlot::display_surface_2d()" << endl;
...
{
    cout << "void MatPlot::display_surface_3d() " << endl;
//    vector<float> rgb;
...
{
    cout << "void MatPlot::display_contour()" << endl;
...
{
    cout << "void MatPlot::display_patch_2d()" << endl;
//    // FaceVertex & CData //
...
{
    cout << "void MatPlot::display_patch_3d()" << endl;
//    // FaceVertex & CData //
//    // XYZ Data //
//    int nf,nv;//number of faces and vertex
//    nf=cp->XData.size();
...
{
    cout << "void MatPlot::display_text()" << endl;
...
{
    cout << "void MatPlot::ptext(float x,float y,string s)" << endl;
//    // Viewport Figure
//    glViewport(0,0, (int)(window_w),(int)(window_h));
//    glLoadIdentity();
//    gluOrtho2D( 0.0, 1.0, 0.0, 1.0 );
...
{
    cout << "void MatPlot::ptext3(float x,float y,float z,string s)" << endl;
//    glColor3f(0,0,0);
//    glRasterPos3d(x,y,z);
//    gl2psText(s.c_str(), "Arial", 12);
//    for(int i=0; i<(int)s.size(); i++ ){
...
{
    cout << "void MatPlot::ptext3c(float x,float y,float z,string s)" << endl;
//    int char_w=6,char_h=12;
